...
public class UsersListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new UserAdapter(new ArrayList<User>(), UsersListActivity.this);
	    ...
	    mFirebaseDatabaseReference.child(TABLE_DB_USERS).addChildEventListener(new ChildEventListener() {
		    ...
		    @Override
		    public void onCancelled(DatabaseError databaseError) {
			    Toast.makeText(UsersListActivity.this, "CANCELLED", Toast.LENGTH_SHORT).show();
	...
	public void startConversation(final String userId) {
		...
		mFirebaseDatabaseReference.child("users").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
			@Override
			public void onDataChange(DataSnapshot dataSnapshot) {
				Intent intent =new Intent(UsersListActivity.this,ChatActivity.class).putExtra(EXTRA_CHAT_WITH, userId);
